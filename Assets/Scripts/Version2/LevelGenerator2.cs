...
public class LevelGenerator2 : MonoBehaviour
{
    ...
    private Vector2 roomSizeWorldUnits = new Vector2(30, 30);
    ...
    private float chanceWalkerChangeDir = 0.5f, chanceWalkerSpawn = 0.5f;
    ...
    void CreatWalls()
    {
        ...
        for (int x = 0; x < roomWidth -1; x++)
        {
            for (int y = 0; y < roomHeight -1; y++)
            {
                //if there a floor, check the spaces around it
